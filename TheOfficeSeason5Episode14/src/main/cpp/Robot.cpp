...
void Robot::RunWrist() {
 ...
 if(elevatorStick.GetRawButton(3)){
    wristMotor->Set(ControlMode::PercentOutput,(0.001));
 ...
 */
  ...
  frc::SmartDashboard::PutNumber("Zaxis", elevatorStick.GetZ());
...
void Robot::RunElevator() {
  ...
  frc::SmartDashboard::PutNumber("J0ystick y",theth);
